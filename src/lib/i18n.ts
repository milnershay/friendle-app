...
export const translations = {
    en: {
        ...
        home: {
            title: 'Friendle',
            subtitle: 'Wordle with friends, elevated',
            playerTitle: 'Player',
            username: 'Username',
            ...
            noRoomsTitle: 'No Public Rooms Available',
            noRoomsSubtitle: 'Why not create one and invite some friends?',
            dailyTitle: 'Daily',
            ranksTitle: 'Ranks',
            played: 'Played',
            winRate: 'Win Rate',
    ...
    he: {
        ...
        home: {
            title: 'פרנדל',
            subtitle: 'וורדל עם חברים, ברמה אחרת',
            playerTitle: 'שחקן',
            username: 'שם משתמש',
            usernamePlaceholder: 'הזן שם',
            createRoom: 'צור חדר',
            or: 'או',
            roomCode: 'קוד חדר',
            roomCodePlaceholder: 'קוד',
            join: 'הצטרף',
            joinRandom: 'הצטרף לחדר אקראי',
            joinWithCode: 'הצטרף עם קוד',
            noRoomsTitle: 'אין חדרים ציבוריים זמינים',
            noRoomsSubtitle: 'אולי תיצרו אחד ותזמינו כמה חברים?',
            dailyTitle: 'יומי',
            ranksTitle: 'דירוג',
            played: 'משחקים',
