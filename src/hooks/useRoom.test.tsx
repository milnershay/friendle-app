...
import { type DataSnapshot, type TransactionResult } from 'firebase/database';
...
describe('useRoom Bug Reproduction', () => {
    ...
    // Test removed: We no longer use updateUserStats since user profiles were removed
    // The submitGuess function now only updates room data without cross-game stats
});
